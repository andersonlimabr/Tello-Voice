...
using System.Linq;
using System.Net;
using TelloSdkStandard.actions;

namespace TelloSdkStandard
{
    public class SdkWrapper
    {
        ...
        {
            var nonCommandActions = flightPlan.Items.Where(a => a.Action.Type == TelloSdkStandard.actions.Action.ActionTypes.Read).ToArray();
